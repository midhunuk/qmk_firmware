...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [L_QWE] = LAYOUT_ortho_4x10(
        ...
        KC_NO,   LT(L_NAV, KC_TAB), KC_SPC,       TO(L_NUM),    KC_NO,      KC_NO, OSL(L_SYM),   KC_ENT,       KC_BSPC,      KC_NO
    ),
    ...
    [L_SYM] = LAYOUT_ortho_4x10(
        ...
        KC_NO,   LT(L_NAV, KC_TAB), KC_SPC,  TO(L_QWE), KC_NO,       KC_NO,  TO(L_QWE),KC_ENT,  KC_BSPC,  KC_NO
    ),
