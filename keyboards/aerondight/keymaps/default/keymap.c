...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [L_QWE] = LAYOUT_ortho_4x10(
        ...
        KC_NO,        KC_NO,   LT(L_NAV, KC_TAB), KC_SPC,       TO(L_NUM),  OSL(L_SYM),  KC_ENT, KC_BSPC,      KC_NO,        KC_NO
    ),
    ...
    [L_SYM] = LAYOUT_ortho_4x10(
        ...
        KC_NO,   KC_NO,    LT(L_NAV, KC_TAB), KC_SPC,  TO(L_QWE),   TO(L_QWE),KC_ENT,  KC_BSPC, KC_NO,    KC_NO
    ),
    ...
    [L_NAV] = LAYOUT_ortho_4x10(
        ...
        KC_LGUI, KC_NO,   KC_NO,   KC_NO,   KC_NO,      MS_LEFT, MS_DOWN, MS_UP,   MS_RGHT,  KC_DEL,
        KC_NO,   KC_NO,   KC_NO,   KC_ESC,  KC_NO,      KC_NO,   MS_BTN1, MS_BTN2, MS_BTN3,  KC_NO
    ),
